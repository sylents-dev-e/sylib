...
typedef struct {
	...
	ppm_config_t app_ppm_conf;

	// ADC application settings
	adc_config_t app_adc_conf;

	// UART application settings
	uint32_t app_uart_baudrate;

	// Nunchuk application settings
	chuk_config_t app_chuk_conf;

	// NRF application settings
	nrf_config_t app_nrf_conf;
} app_config_t;
...
typedef enum {
    ...
    CMD_ERASE_NEW_APP,
    CMD_WRITE_NEW_APP_DATA,
    CMD_GET_VALUES,
    CMD_SET_DUTY,
    CMD_SET_CURRENT,
    CMD_SET_CURRENT_BRAKE,
    CMD_SET_RPM,
    CMD_SET_POS,
    CMD_SET_HANDBRAKE,
    CMD_SET_DETECT,
    ...
    CMD_SET_MCCONF,
    CMD_GET_MCCONF,
    CMD_GET_MCCONF_DEFAULT,
    CMD_SET_APPCONF,
    CMD_GET_APPCONF,
    CMD_GET_APPCONF_DEFAULT,
    CMD_SAMPLE_PRINT,
    CMD_TERMINAL_CMD,
    CMD_PRINT,
    CMD_ROTOR_POSITION,
    CMD_EXPERIMENT_SAMPLE,
    CMD_DETECT_MOTOR_PARAM,
    CMD_DETECT_MOTOR_R_L,
    CMD_DETECT_MOTOR_FLUX_LINKAGE,
    CMD_DETECT_ENCODER,
    CMD_DETECT_HALL_FOC,
    CMD_REBOOT,
    CMD_ALIVE,
    CMD_GET_DECODED_PPM,
    CMD_GET_DECODED_ADC,
    CMD_GET_DECODED_CHUK,
    CMD_FORWARD_CAN,
    CMD_SET_CHUCK_DATA,
    CMD_CUSTOM_APP_DATA,
    CMD_NRF_START_PAIRING,
    CMD_NONE
} CMD_PACKET_ID;
